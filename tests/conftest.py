...
def mock_successful_transcription():
    ...
    return create_mock_transcription_result(
        ...
        segments=[
            {'start': 0.0, 'end': 2.0, 'text': 'This is a successful', 'avg_logprob': -0.2},
            {'start': 2.0, 'end': 4.0, 'text': ' test transcription', 'avg_logprob': -0.3},
            {'start': 4.0, 'end': 6.0, 'text': ' with multiple segments.', 'avg_logprob': -0.25}
        ]
    )