    ...
    def test_transcribe_success(
        ...
        with patch("pathlib.Path.exists", return_value=True), patch(
            ...
            mock_open.return_value.__enter__.return_value.read.return_value = (
                json.dumps(mock_whisper_result)
            )
...
class TestModelManager:
    ...
    def test_download_single_model(self, mock_get):
        ...
        with patch.object(manager.cache_dir, "mkdir"), patch.object(
...
class TestCompleteWorkflow:
    ...
    def setup_managers(self):
        ...
        with patch("src.environment_manager.EnvironmentManager") as mock_env, patch(
    ...
    def test_environment_setup_workflow(self, setup_managers):
        ...
        with patch("venv.create") as mock_venv, patch("subprocess.run") as mock_run:
